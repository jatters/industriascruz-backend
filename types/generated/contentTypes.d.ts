...
export interface ApiAttributeAttribute extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['Color', 'Superficie', 'Tama\u00F1o']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    deliveryMethods: Schema.Attribute.Enumeration<
      [
        'Producto armado',
        'Producto en caja',
        'Producto desarmado',
    ...
    icons: Schema.Attribute.Component<'icons.iconos', false>;
    image: Schema.Attribute.Media<'images'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    variations: Schema.Attribute.Component<'variaciones.variaciones', true>;
